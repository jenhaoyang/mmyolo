...
from .yolov3_head import YOLOv3Head, YOLOv3HeadModule
from .yolov4_head import YOLOv4Head, YOLOv4HeadModule
...
__all__ = [
    ...
    'YOLOXPoseHead', 'YOLOXPoseHeadModule', 'YOLOv4Head', 'YOLOv4HeadModule',
    'YOLOv3Head', 'YOLOv3HeadModule'
]
